"""
API routes module - Route handlers for FastAPI.

Provides all API route handlers organized by domain.
...
router.include_router(gitea.router, prefix="/api/gitea", tags=["Gitea"])
