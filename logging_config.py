"""
Enhanced logging configuration for Claude Code Skill Registry.
...
if __name__ == "__main__":
    ...
    logger.info("Application started", extra={"app_version": "1.0.0"})

    # Test sensitive data masking
    logger.info("User login attempt",
               extra={"employee_id": "123456", "api_key": "secret-key-123"})

    # Test audit logging
    audit_log(logger, "user_login", user_id=1, ip_address="192.168.1.1")
